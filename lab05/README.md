...
![Геометрическая интерпретация вероятности](py/geom.png)_Рисунок 1. Геометрическая интерпретация._
...
![Алгоритм получения ответа](py/algorithm.png)  _Рисунок 2. Алгоритм генерации события из группы событий._
...
![Интерфейс](py/view.png)_Рисунок 3. Интерфейс приложения._
___
### Вывод
