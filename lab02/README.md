...
Температура в центре меняется незначительно, так как температуропроводность свинца мала.

---
Вывод: за свинцовой дверью толщиной 20 см, в стерильных условиях (т.е. без учета ударной волны, радиации и прочего, беря только температуру при ядерном взрыве), можно прожить как минимум 10 секунд, так как внутренняя часть пластины практически не нагревается.
